...
public class SoftDeletableAggregateRootTests
{
    private sealed class TestEvent : IDomainEvent;

    private sealed class FakeSoftDeletableAggregate(Guid id) : SoftDeletableAggregateRoot<Guid>(id)
    {
    ...
    {
        var aggregate = new FakeSoftDeletableAggregate(Guid.NewGuid());
